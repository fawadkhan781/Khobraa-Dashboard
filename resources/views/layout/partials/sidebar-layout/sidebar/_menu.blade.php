    ...
    <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true"
        ...
        <div class="menu menu-column menu-rounded menu-sub-indention px-3 fw-semibold fs-6" id="#kt_app_sidebar_menu"
            ...
            <div class="menu-item">
                ...
                <a class="menu-link {{ request()->routeIs('customer') ? 'active' : '' }}"
                    href="{{ route('customer') }}">
                    <span class="menu-link">
                        <span class="menu-icon">{!! getIcon('element-11', 'fs-2') !!}</span>
                ...
                <a class="menu-link {{ request()->routeIs('jobs') ? 'active' : '' }}" href="{{ route('jobs') }}">
                    <span class="menu-link">
                        <span class="menu-icon">{!! getIcon('element-11', 'fs-2') !!}</span>
                ...
                <a class="menu-link {{ request()->routeIs('recipts') ? 'active' : '' }}" href="{{ route('recipts') }}">
                    <span class="menu-link">
                        <span class="menu-icon">{!! getIcon('element-11', 'fs-2') !!}</span>
                        <span class="menu-title"> Recipts</span>
                    </span>
                </a>
            ...
            <div data-kt-menu-trigger="click"
                class="menu-item menu-accordion d-none {{ request()->routeIs('user-management.*') ? 'here show' : '' }}">
                <!--begin:Menu link-->
                <span class="menu-link">
