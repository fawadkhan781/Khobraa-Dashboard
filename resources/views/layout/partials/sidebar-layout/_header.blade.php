<!--begin::Header-->
<div id="kt_app_header" class="app-header d-none" data-kt-sticky="true" data-kt-sticky-activate="{default: true, lg: true}" data-kt-sticky-name="app-header-minimize" data-kt-sticky-offset="{default: '0px', lg: '0'}" data-kt-sticky-animation="false" style="display: none;">
